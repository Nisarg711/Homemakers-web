        ...
        <div className="w-96 h-[520px] bg-dark-bg-secondary border border-dark-border rounded-xl shadow-dark-xl flex flex-col mb-4">
          ...
          <div className="p-4 border-t border-dark-border flex gap-2">
            <input
              ...
              className="flex-1 bg-dark-bg-primary text-dark-text text-black border border-dark-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-accent-primary"
            />
            <button
              onClick={sendMessage}
